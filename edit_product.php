                    ...
                    if($img_size>= 1000000){
                        ...
                        if(move_uploaded_file($img_tmp,$store)){
                            ...
                            if(!isset($error)){
                                ...
                                stock=:stock,min_stock=:min_stock,product_berat=:product_berat ,description=:description, img=:img WHERE product_id=$id");
                                ...
                                $update->bindParam('product_berat', $berat_req);
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" step="1"
                            class="form-control" name="berat" value="<?php echo $berat_db; ?>" required>
                        </div>
                        <div class="form-group">
