                ...
                if($img_size>= 1000000){
                    ...
                    if(move_uploaded_file($img_tmp,$store)){
                        ...
                        if(!isset($error)){
                            ...
                            $insert = $pdo->prepare("INSERT INTO tbl_product(product_code,product_name,product_category,purchase_price,sell_price,stock,min_stock,product_berat,description,img)
                            values(:product_code,:product_name,:product_category,:purchase_price,:sell_price,:stock,:min_stock,:berat,:desc,:img)");
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-muted">*Berat dalam gram</span>
                            <input type="number" 
                            class="form-control" name="berat" required>
                        </div>
                        <div class="form-group">
