            ...
            <div class="box-body">
              <div class="row">
                ...
                <br>
                  ...
                  <?php
                    $select = $pdo->prepare("SELECT sum(harga) as total, count(inv_id) as invoice FROM tbl_invoice
              ...
              <div style="overflow-x:auto;">
                  <table class="table table-striped" id="mySalesReport">
                      ...
                      <tbody>
                      <?php
                            $select = $pdo->prepare("SELECT * FROM tbl_invoice i INNER JOIN tbl_product p ON p.product_id = i.produk WHERE i.order_date BETWEEN :fromdate AND :todate");
                            $select->bindParam(':fromdate', $_POST['date_1']);
                            $select->bindParam(':todate', $_POST['date_2']);
              ...
              <!-- Transaction Graphic -->
              <?php
                  $select = $pdo->prepare("SELECT order_date, sum(harga) as price FROM tbl_invoice WHERE order_date BETWEEN :fromdate AND :todate
                  GROUP BY order_date");
                  $select->bindParam(':fromdate', $_POST['date_1']);
                  $select->bindParam(':todate', $_POST['date_2']);
                  $select->execute();
